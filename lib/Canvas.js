...
var loadImage = _utils.loadImage;
var rgbToHex = _utils.rgbToHex;
...
class Canvas {
  ...
  getAvgColor(data) {
    ...
    return rgbToHex(rgb.r, rgb.g, rgb.b); // return `rgb(${rgb.r}, ${rgb.g}, ${rgb.b})`;
  }
  ...
  getColors() {
    ...
    const parts = [[width / 4, height / 4, width / 4, height / 4], [0, 0, width / 2, height / 2], [width / 2, 0, width / 2, height / 2], [0, height / 2, width / 2, height / 2], [width / 2, height / 2, width / 2, height / 2]];
